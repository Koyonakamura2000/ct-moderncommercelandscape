...
var promptDict = {};
promptDict["Include interactive features to improve the store browsing experience"] = ["Content", "Images", "Video"];
...
promptDict["Improve website performance"] = ["Optimization", "CDN", "JAMStack Hosting"];
...
var descriptionDict = {};
descriptionDict["Frontend"] = "General package for the customer-facing interface for your service.";
descriptionDict["CDN"] = "Content Delivery Networks improve website availability and performance by optimizing for geographic location.";
descriptionDict["Optimization"] = "Improve website load-times for a faster user experience.";
descriptionDict["JAMStack Hosting"] = "Host your website on the cloud to avoid server management.";
descriptionDict["Frontend-as-a-Service"] = "Beginner-friendly, efficient website-building without having to code.";
descriptionDict["A/B Testing"] = "A/B testing helps you improve website engagement/retainment through statistical analysis.";
descriptionDict["SEO"] = "Search Engine Optimization improves your website's discoverability on search engines.";
descriptionDict["Store"] = "STORE";
descriptionDict["Clienteling"] = "Empower retail associates to foster customer relationships and improve the in-store experience.";
descriptionDict["POS"] = "POS";
descriptionDict["Social"] = "SOCIAL";
descriptionDict["AR"] = "AR";
descriptionDict["Backend"] = "Backend";
descriptionDict["Content"] = "Headless content management decouples the frontend (customer-facing interface) and the backend (files, images, etc.) for increased flexibility and scalability across devices.";
descriptionDict["DAM"] = "Digital Asset Management lets you organize all your digital assets (e.g., documents, videos, images) in a single location."
descriptionDict["Images"] = "Manage your images in a single location.";
// descriptionDict["Videos"] = "Manage your videos in a single location.";
descriptionDict["Workflow/Approval"] = "WORKFLOW/APPROVAL";
descriptionDict["Commerce"] = "Handle the backend of your commercial service, with complete freedom on frontend implementation.";
descriptionDict["Orders"] = "Orders";
descriptionDict["Single Page Checkout"] = "Quick and easy secure checkout experience.";
descriptionDict["Payment"] = "Suite of services to handle online payment.";
descriptionDict["Fraud"] = "Protect against business fraud and cyber attacks.";
descriptionDict["Wallets"] = "WALLETS";
descriptionDict["Gift Cards"] = "GIFT CARDS";
descriptionDict["Taxes"] = "Automate sales tax calculations.";
descriptionDict["Subscriptions"] = "Automate the handling of subscriptions for your service.";
descriptionDict["Product"] = "PRODUCT";
descriptionDict["Search"] = "Improve the search feature of your service.";
// descriptionDict["Conversational"] = "CONVERSATIONAL";
descriptionDict["Visual"] = "Visual";
descriptionDict["Recommendations"] = "Recommendations";
descriptionDict["In-store"] = "In-store";
descriptionDict["Ratings & Reviews"] = "Collect and display user-generated ratings and reviews.";
descriptionDict["Pricing"] = "Automate price management of your products to smartly adjust prices.";
descriptionDict["Promotions"] = "Automate promotion marketing without wasting development time and money.";
descriptionDict["Coupons"] = "Coupons";
descriptionDict["Inventory"] = "Inventory";
descriptionDict["Social Listing"] = "Advertise your product to social media audiences.";
descriptionDict["Customer"] = "Customer";
descriptionDict["Loyalty"] = "Foster customer loyalty leveraging customer metrics.";
descriptionDict["Personalization"] = "Connect with customers personally with personalized content.";
descriptionDict["OMS"] = "Order Management Systems handle order entry and processing for online and physical stores.";
descriptionDict["Store-based"] = "Store-based";
descriptionDict["PIM"] = "Product Information Management helps you manage your products in a single place.";
descriptionDict["Product Enrichment"] = "Provide additional product information for customers looking for specific details.";
descriptionDict["Content Distribution/Enrichment"] = "Find and update missing, inaccurate, or outdated product information.";
descriptionDict["Commerce Platforms"] = "Build a complete online platform for your commercial service.";
descriptionDict["Marketplace Platforms"] = "Build an online marketplace organizing products from various sellers.";
descriptionDict["Outbound Contact"] = "E-mail, phone, and other communication services for your platform.";
descriptionDict["CPQ"] = "Short for Configure, Price, and Quote, CPQ helps you figure out the right product/service combinations for your business needs.";
descriptionDict["GraphQL Client"] = "";
descriptionDict["GraphQL Server"] = "";
descriptionDict["Identity & Access Management"] = "";
descriptionDict["Continuous Delivery Tooling"] = "";
...
categoryTree["CDN"] = ["Optimization", "JAMStack Hosting"];
categoryTree["Store"] = ["Clienteling", "POS"];
categoryTree["Backend"] = ["Content", "Commerce", "OMS", "PIM", "Marketplace", "Marketing", "Service", "CRM", "Analytics", "CPQ", "MDM", "Globalization/Localization"];
categoryTree["Content"] = ["DAM", "Workflow/Approval"];
...
categoryTree["OMS"] = ["Store-based", "Shipping"];
...
categoryCompanies["Optimization"] = ["Moovweb", "Yottaa"];
...
categoryCompanies["Content"] = ["Contentstack", "Contentful", "Amplience", "GraphCMS", "CoreMedia"];
...
categoryCompanies["Store-based"] = ["NewStore", "Tulip"];
